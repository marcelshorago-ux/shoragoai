...
const COPY: Record<Lang, Copy> = {
  en: {
    ...
    offer_note: 'Founding 10 customers • price locked for 12 months',  // <-- NEW
    offer_points: [
  ...
  es: {
    ...
    offer_note: 'Primeros 10 clientes fundadores • precio fijo por 12 meses',   // <-- NEW
    offer_points: [
    ...
    <main className="min-h-screen bg-gradient-to-b from-[#0c0a0f] via-[#0e0a13] to-[#0b0b0f] text-zinc-100">
      ...
      <section className="container mx-auto max-w-6xl px-4 pt-14 md:pt-20">
        <div className="rounded-2xl bg-white/5 p-6 ring-1 ring-white/10">
          ...
          <p className="mt-1 text-xs text-zinc-400">{t.offer_note}</p> {/* <-- NEW subtle note */}
